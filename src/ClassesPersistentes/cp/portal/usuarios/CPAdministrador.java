...
@Audited
@Entity
public class CPAdministrador extends ABSUsuario implements Serializable {
    ...
    public CPAdministrador(String login, String senha, String emailPrincipal) {
        super.setLogin(login);
        super.setSenha(senha);
        super.setEmailPrincipal(emailPrincipal);
    }

    public CPAdministrador() {
    }
