 ...
 * @author Thiago-Asus
 */
public abstract class ABSGraficoEntradaSaida extends ABSGraficoSalvo  {

    private static final long serialVersionUID = 1L;

    public static ABSGraficoEntradaSaida getInstance(){
        return new ABSGraficoEntradaSaida() {private static final long serialVersionUID = 1L;};
    }
